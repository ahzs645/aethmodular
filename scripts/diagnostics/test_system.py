...
class ETADSystemTester:
    ...
    def __init__(self):
        ...
        self.data_path = os.environ.get(
            "AETH_SAMPLE_PKL",
            str(REPO_ROOT / "research" / "ftir_hips_chem" / "df_Jacros_9am_resampled.pkl"),
        )
    ...
    def test_core_imports(self):
        ...
        try:
            from src.core.base import BaseLoader, BaseAnalyzer
    ...
    def test_data_loaders(self):
        ...
        try:
            from src.data.loaders.aethalometer import AethalometerPKLLoader, load_aethalometer_data
    ...
    def test_utilities(self):
        ...
        try:
            ...
            from src.utils.file_io import save_results_to_json, ensure_output_directory
    ...
    def test_analysis_modules(self):
        ...
        try:
            from src.analysis.bc.black_carbon_analyzer import BlackCarbonAnalyzer
            self.test_result(True, "Black carbon analyzer imported")
            
            # Try to import other analysis modules if they exist
            try:
                from src.analysis.bc.source_apportionment import SourceApportionmentAnalyzer
    ...
    def test_data_loading(self):
        ...
        try:
            ...
            # Test modular loader
            from src.data.loaders.aethalometer import AethalometerPKLLoader
