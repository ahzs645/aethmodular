...
[Filter identity, reported bounds and original portal row links](../data/proportionality/USPA-0257_filter_evidence.json)
connect the physical filter to its source records. [The retained crosswalk](../data/stability/USPA-0257_record_crosswalk.parquet)
and [original targeted retrieval](../data/stability/USPA-0257_candidate_retrieval.json)
...
timing errors. [Local source] (external source recorded in provenance); SHA-256 `d18ed9c836f965a19221b2da3bce30538adcd08fbf7638e1df476e88b02854e0`.
...
[Per-record flags](../data/proportionality/USPA-0257_candidate_status_screen.parquet) retain timestamps,
