...
- [Original source rows](../data/stability/CHTS-0658_original_source_rows.csv), with original preamble and header.
- [All source metadata](../data/stability/CHTS-0658_source_metadata.csv).
- [Mapping to unified measurement rows](../data/stability/CHTS-0658_unified_row_links.csv).
- [Frozen original measurements](../data/diagnostic/original_measurements.parquet), indexed by source_row.

Source: [FilterBased_ChemSpecPM25_CHTS.csv] (external source recorded in provenance)
...
[Exact filter and original EC source-row links](../data/proportionality/FTIR_calibration_identifier_filter_links.csv)
